...
import com.warframe.squad.dao.WarframeOperatorsDao;
import com.warframe.squad.entity.Operator;
import lombok.extern.slf4j.Slf4j;

@Service
@Slf4j
public class DefaultWarframeOperatorsService implements WarframeOperatorsService {
  
  @Autowired
  private WarframeOperatorsDao warframeOperatorsDao;
